...
\definecolor{cb_blue}{HTML}{4477AA}
\definecolor{cb_orange}{HTML}{EE7733}
\definecolor{cb_red}{HTML}{CC3311}
\definecolor{cb_teal}{HTML}{009988}
\definecolor{cb_gray}{HTML}{BBBBBB}
\definecolor{cb_green}{HTML}{228833}
\definecolor{cb_lightgray}{HTML}{AAAAAA}

%algos
\newcommand{\xdata}{x^{\text{data}}}
\newcommand{\xzero}{x^{0}}
\newcommand{\xtheta}{x^{\theta}}
\newcommand{\pidata}{\pi_{\text{data}}}
\newcommand{\pizero}{\pi_{0}}
\newcommand{\pitheta}{\pi_{\theta}}
\newcommand{\Vtheta}{V_\theta}
\newcommand{\qgreedy}{q_{\text{greedy}}}
\newcommand{\qmixing}{q_{\text{mixing}}}