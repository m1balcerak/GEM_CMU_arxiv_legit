...
\begin{tikzpicture}[scale=1.15]
  ...
  \node[font=\scriptsize, text=cb_teal] at (1.26,-0.16) {annealed proposal, $S_{\mathrm{anneal}}$};
  ...
  \node[font=\scriptsize, text=cb_blue] at (4.20,-0.16) {fixed-temperature proposal};
