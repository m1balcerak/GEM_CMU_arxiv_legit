...
\end{equation}
In our setting, \(E_\theta(x)=\beta_{\mathrm{mh}} V_\theta(x)\), and we approximate the model expectation with samples from the current chain while stopping gradients through the sampler, yielding the energy refinement objective in the main text.
