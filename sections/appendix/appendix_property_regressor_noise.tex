...
report four representative properties (SAS, logS, logP, QED). As expected, errors are large for
...
\addplot+[thick, purple!70!black] coordinates {
  (0.0, 0.7199128723)
  (0.2, 0.7027059631)
  (0.4, 0.6730399292)
  (0.6, 0.6084385590)
...
\end{axis}
\end{tikzpicture}
\caption{\footnotesize \textbf{Regressor Noise Sensitivity.} Test MAE of time/noise-conditioned property regressors versus noise level $t$
