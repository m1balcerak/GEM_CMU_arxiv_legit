...
\label{proposals}
Motivated by the JKO formulation in \Cref{jko_em}, we now derive two discrete kernels corresponding to two distinct sampling regimes, i.e., the transport-dominated regime (deterministic $\epsilon\to 0$ limit) and the mixing regime ($\epsilon>0$).
