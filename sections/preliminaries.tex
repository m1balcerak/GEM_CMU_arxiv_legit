...
\end{align}
where the cost function \( c(x,y) \) measures the amount of displacement when transporting mass from \(x\) to \(y\), and constitutes a design choice, which in continuous spaces is typically chosen as \( c(x,y)=\|x - y\|^2 \).
